...
const makeGalleryImages = images.map(({ url, alt }) =>
  `<li class="gallery__item"><img class="gallery__image" src="${url}" alt="${alt}" width="320" /></li>`)
  .join("");

galleryListEl.insertAdjacentHTML("beforeend", makeGalleryImages);
